...
from stock_analyse.application.use_cases.analyze_financials import execute as analyze_financials_use_case
from stock_analyse.application.use_cases.analyze_reports import execute as analyze_reports_use_case
from stock_analyse.application.workflows.dividend_analysis_workflow import StockFenHengAnalyser
from stock_analyse.application.workflows.technical_analysis_workflow import TechnicalAnalysisWorkflow as StockAnalyzer
...
def print_report_stock():
    ...
    try:
        df_report_filter_zcfz, df_report_filter_lrb, df_report_filter_xjll, df_pivot_zcfz, df_pivot_lrb, df_pivot_xjll = analyze_reports_use_case(market='SH')
...
def print_financial_stock():
    try:
        df_fh, summary = analyze_financials_use_case(
            market='SH',
