...
# 美股实时行情
PYTHONPATH=/mnt/github/stock/stockAnalyse/src uv run scripts/main.py --action=spot --market=usa

# 港股实时行情
PYTHONPATH=/mnt/github/stock/stockAnalyse/src uv run scripts/main.py --action=spot --market=H
```
