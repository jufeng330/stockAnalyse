...
def load_futu_financial(market, table_name, start_batch):
    print(f"Fetching {market} financial data starting from batch {start_batch}...")
...
# The last log was for US market, around batch 21
load_futu_financial('usa', 'financial_indicate_usa', 20)
