...
# 财务指标分析
PYTHONPATH=/home/inspur/codes/stockAnalyse/src uv run scripts/main.py --action=indicators --market=SH --symbol=601318

# DCF 估值
PYTHONPATH=/home/inspur/codes/stockAnalyse/src uv run scripts/main.py --action=valuation --market=H --symbol=0700
```
