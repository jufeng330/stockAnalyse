...
* **板块概览**:系统性地列出所有概念板块 (`list_concept`) 与行业板块 ([list_industry](file:///home/inspur/codes/stockAnalyse/backend/main.py#L147-L150))。
* **成分查询**:获取特定板块的全部成分股列表 ([components](file:///home/inspur/codes/stockAnalyse/backend/main.py#L90-L92))。
* **反向映射**:根据股票代码查找其所属的所有概念和行业 ([by_stock](file:///home/inspur/codes/stockAnalyse/backend/utils/concept_query.py#L34-L45))。
