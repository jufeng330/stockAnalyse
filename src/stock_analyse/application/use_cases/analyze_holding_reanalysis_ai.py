...
def execute(
    ...
    orchestrator: HoldingStockReanalysisOrchestrator | None = None,
) -> dict:
    try:
        orchestrator = orchestrator or HoldingStockReanalysisOrchestrator()
        ...
        return build_error_response(message='持仓二次分析失败', error=str(exc))
