(() => {
  const groups = [
    ...
    },
    {
      ...
      href: '/holding-stocks',
      children: [
        { key: 'holding-table', label: '持仓列表', href: '#holding-table' },
        { key: 'holding-review', label: '复盘', href: '/holding-review' },
        { key: 'holding-status-refresh', label: '持仓状态刷新', href: '/holding-status-refresh' },
        { key: 'holding-reanalysis', label: '二次分析 / 再评估', href: '/holding-reanalysis' },
        { key: 'add-position-decision', label: '补仓决策', href: '/add-position-decision' },
        { key: 'reduce-position-decision', label: '减仓决策', href: '/reduce-position-decision' },
        { key: 'sell-decision', label: '卖出决策', href: '/sell-decision' },
        { key: 'weekly-holding-review', label: '周复盘', href: '/weekly-holding-review' },
        { key: 'monthly-holding-review', label: '月复盘', href: '/monthly-holding-review' },
        { key: 'quarterly-holding-review', label: '季度复盘', href: '/quarterly-holding-review' },
  ...
  const pageMeta = {
    ...
    'holding-stocks': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'holding-table', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'holding-review': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'holding-review', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'holding-status-refresh': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'holding-status-refresh', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'holding-reanalysis': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'holding-reanalysis', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'add-position-decision': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'add-position-decision', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'reduce-position-decision': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'reduce-position-decision', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'sell-decision': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'sell-decision', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'weekly-holding-review': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'weekly-holding-review', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'monthly-holding-review': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'monthly-holding-review', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
    'quarterly-holding-review': { groupKey: 'holding-stocks-group', groupActive: true, currentKey: 'quarterly-holding-review', brandText: '持仓管理动作页，统一承接复盘与决策记录。' },
