...
def get_stock_analysis(stock_code, market,start_date_str, end_date_str,
    ...
    return image_paths, strategies_selected, stock_summary, stock_analysis_result, annual_report_analysis, sentiment_analysis
...
def index():
    ...
    if request.method == 'POST':
        ...
        image_paths, strategies_selected, stock_summary, stock_analysis_result, annual_report_analysis, sentiment_analysis = get_stock_analysis(
